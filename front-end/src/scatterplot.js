...
const drawScatterPlot = (props) => {
    ...
    var x_data  = [];
    var y_data = [];
    console.log("scatterplot full data",data)
    var count_data = 0;
    for(var k in data){
        count_data = count_data + 1;
        var val = data[k];
        x_data.push(parseFloat(val["Column_0"]));
        y_data.push(parseFloat(val["Column_1"]));
    }
    console.log("count data is "+count_data);
    console.log("scatterplot x-data is "+x_data);
    console.log("scatterplot y-data is "+y_data);
    /*
