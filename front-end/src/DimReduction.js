...
export default class DimReduction extends Component {
    ...
    render(){
        ...
        return(
            <div className="dim_red_canvas">
              <Container data={this.state.loading_data} toDraw="SCATTERPLOT" xLabel = "PC0" yLabel = "PC1" titleGraph="ScatterPlot" containerClass="dim_red_canvas"/>
            <Container data={this.state.pca_data}  elbow={this.state.elbow_point} xLabel = "Feature" yLabel = "Significance" titleGraph="Significance Graph" toDraw="LINECHART" containerClass="dim_red_canvas"/>
            </div>
        )
    }
